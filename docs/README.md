...
| [`key-rotation-runbook.md`](key-rotation-runbook.md) | Procedure for rotating Ed25519 + ML-DSA-44 keys (stub today; full ceremony defined in Sprint 5/E1.5) |
| [`roadmap.md`](roadmap.md) | E1 ✅ → E1.5 → E2 → E3 → Sprint 6/F1+F2 → Sprint 7/G1-G3 |
